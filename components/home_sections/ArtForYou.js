...
const imagePaths = [
    ...
    { path: require('../../assets/realArt/EDS_ZEBRA.png'), artistName: 'Karla Maldonando', artTitle: 'Title3', artYear: '2019', artDescription: 'desc 2', artType: 'Digital' },
    { path: require('../../assets/realArt/Opiods.png'), artistName: 'Nimco Inc', artTitle: 'Title4', artYear: '2018', artDescription: 'desc 2', artType: 'Digital' },
    { path: require('../../assets/realArt/Lasting_Impacts.png'), artistName: '@Artist4', artTitle: 'Title5', artYear: '2017', artDescription: 'desc 2', artType: 'Digital' },
    { path: require('../../assets/realArt/Melt.png'), artistName: '@Artist5', artTitle: 'Title6', artYear: '2016', artDescription: 'desc 2', artType: 'Digital' },
